...
@InputType()
class CommunityFeedUpdateManyWithoutCommunitiesInput {
...
export { CommunityFeedUpdateManyWithoutCommunitiesInput as CommunityFeedUpdateManyWithoutCommunitiesInput };
