...
@InputType()
class CommunityFeedCreateNestedManyWithoutCommunitiesInput {
...
export { CommunityFeedCreateNestedManyWithoutCommunitiesInput as CommunityFeedCreateNestedManyWithoutCommunitiesInput };
